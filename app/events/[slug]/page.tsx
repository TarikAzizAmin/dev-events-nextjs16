...
<div className="flex flex-row gap-1.5 flex-wrap">
    {tags.map((tag)=>(<div className="pill" key={tag}>
        {tag}
    </div>))}
</div>
)
        ...
        <section id="event">
            ...
            <div className="details">
                ...
                <div className="content">
                    <Image src={image} alt="Event Banner" width={600} height={600} className="banner"/>
                ...
                <aside className="booking">
                    <div className="signup-card">
                        ...
                        {bookings > 0? (
                            <p className="text-sm">
                                Join now, {bookings} people who have already booked their spot!
                            </p>
                        ):
                        <p className="text-sm">
